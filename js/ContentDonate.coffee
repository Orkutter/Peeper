		...
		h("div#Content.center", [
			if Page.local_storage_loaded
				h("div.post.settings",{style:"border-radius: 16px"},[
					...
					h("img",{src:"img/bitcoin_1PEEPJuD41shof53g3WauQKi4k4wVe3Vzu.png", width:"400px"})
					h("br")
					h("a",{href:"bitcoin:1PEEPJuD41shof53g3WauQKi4k4wVe3Vzu"},"1PEEPJuD41shof53g3WauQKi4k4wVe3Vzu")
					...
					h("a",{href:"https://blockchain.info/address/1PEEPJuD41shof53g3WauQKi4k4wVe3Vzu"},"here")
					...
					h("a",{href:"https://github.com/ZeroNetPlus/Peeper/issues"},"GitHub issues")
					h("span",".")
					h("h4","Questions?")
